...
namespace LumisCalendarSync.ViewModels
{
    ...
    /// Because ICommand takes an object, having a value type for T would cause unexpected behavior when CanExecuteFunction(null) is called during XAML initialization for command bindings.
    ...
    public class DelegateCommand<T> : DelegateCommandBase
    {
        ...
        /// </summary>
        /// <param name="executeMethod">Delegate to execute when Execute is called on the command. This can be null to just hook up a CanExecuteFunction delegate.</param>
        ...
        /// </summary>
        /// <param name="executeMethod">Delegate to execute when Execute is called on the command. This can be null to just hook up a CanExecuteFunction delegate.</param>
        /// <param name="canExecuteMethod">Delegate to execute when CanExecuteFunction is called on the command. This can be null.</param>
